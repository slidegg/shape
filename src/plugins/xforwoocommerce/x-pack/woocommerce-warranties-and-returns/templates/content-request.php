...
?>
	<div class="wcwar_warranty woocommerce">
		...
		<p><?php esc_html_e( 'Warranty requests for users that are not logged in are allowed. Please fill in the form below to view your warranty request.', 'xforwoocommerce' ); ?></p>
		<p>
