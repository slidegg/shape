<div class="isb_sale_badge <?php echo esc_attr( $isb_class ); ?>" data-id="<?php echo esc_attr( $isb_price['id'] ); ?>">
	<div class="isb_sale_title <?php echo esc_attr( $isb_curr_set['color'] ); ?>">
		<span class="isb_sale_title_text"><?php echo ( isset( $isb_curr_set['special_text'] ) && $isb_curr_set['special_text'] !== '' ? $isb_curr_set['special_text'] : esc_html__( 'On Sale!', 'xforwoocommerce' ) ); ?></span>
	</div>
