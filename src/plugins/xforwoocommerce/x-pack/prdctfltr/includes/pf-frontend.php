	...
	class XforWC_Product_Filters_Frontend {
		...
		function localize_scripts() {
			...
			if ( !isset( $prdctfltr_global['init'] ) ) {
				...
				$curr_args = apply_filters( 'prdctfltr_localize_javascript', array(
					...
					'localization' => array(
						'close_filter' => esc_html__( 'Close filter', 'xforwoocommerce' ),
						'filter_terms' => esc_html__( 'Filter terms', 'xforwoocommerce' ),
						'ajax_error' => esc_html__( 'AJAX Error!', 'xforwoocommerce' ),
						'show_more' => esc_html__( 'Show more', 'xforwoocommerce' ),
						'show_less' => esc_html__( 'Show less', 'xforwoocommerce' ),
						'noproducts' => esc_html__( 'No products found!', 'xforwoocommerce' ),
						'clearall' => esc_html__( 'Clear filters', 'xforwoocommerce' ),
						'getproducts' => esc_html__( 'Show products', 'xforwoocommerce' )
					),
				...
				<a class="button prdctfltr_woocommerce_filter_submit" href="#">
					<?php
						if ( self::$settings['instance']['style']['filter_button'] !== '' ) {
							...
							esc_html_e( 'Filter selected', 'xforwoocommerce' );
						}
					?>
				</a>
			<?php
				...
				<span class="prdctfltr_sale">
					<?php
					printf('<label%2$s><input name="sale_products" type="checkbox"%3$s/><span>%1$s</span></label>', esc_html__('Show only products on sale' , 'xforwoocommerce' ), ( isset($pf_activated['sale_products']) ? ' class="prdctfltr_active"' : '' ), ( isset($pf_activated['sale_products']) ? ' checked' : '' ) );
					?>
				</span>
				<?php
				}
				...
				<?php
					if ( get_option( 'woocommerce_hide_out_of_stock_items', 'no' ) == 'yes' ) {
						printf('<label%2$s><input name="instock_products" type="checkbox" value="both"%3$s/><span>%1$s</span></label>', esc_html__('Show out of stock products' , 'xforwoocommerce' ), ( isset($pf_activated['instock_products']) ? ' class="prdctfltr_active"' : '' ), ( isset($pf_activated['instock_products']) ? ' checked' : '' ) );
					}
					else {
						printf('<label%2$s><input name="instock_products" type="checkbox" value="in"%3$s/><span>%1$s</span></label>', esc_html__('In stock only' , 'xforwoocommerce' ), ( isset($pf_activated['instock_products']) ? ' class="prdctfltr_active"' : '' ), ( isset($pf_activated['instock_products']) ? ' checked' : '' ) );
					}
			?>
				</span>
			<?php
		...
		public static function __get_customized_term_none( $style ) {
			switch( $style ) {
				...
				break;
				default :
					return apply_filters( 'prdctfltr_none_text', esc_html__( 'None', 'xforwoocommerce' ) );
				break;
			}
			return '';
		}
		...
		public static function get_customized_term_700( $term_id, $term_slug, $term_name, $cnt, $checked = '', $sublevel = '' ) {
			...
			if ( !empty( $term_id ) ) {
				...
				$data = array(
					'value' => '',
					'title' => apply_filters( 'prdctfltr_none_text', esc_html__( 'None', 'xforwoocommerce' ) ),
					'tooltip' => apply_filters( 'prdctfltr_none_tooltip', esc_html__( 'Clear filters', 'xforwoocommerce' ) ),
...
<?php
		...
		public static function nice_number( $n ) {
			...
			if ( $n > 1000000000000 ) {
				return round( ( $n / 1000000000000 ) , 1 ).' ' . esc_html__( 'trillion' , 'xforwoocommerce' );
			}
			else if ( $n > 1000000000 ) {
				return round( ( $n / 1000000000 ) , 1 ).' ' . esc_html__( 'billion' , 'xforwoocommerce' );
			}
			else if ( $n > 1000000 ) {
				return round( ( $n / 1000000 ) , 1 ).' ' . esc_html__( 'million' , 'xforwoocommerce' );
			}
			else if ( $n > 1000 ) {
				return round( ( $n / 1000 ) , 1 ).' ' . esc_html__( 'thousand' , 'xforwoocommerce' );
			}
		...
		public static function get_taxonomy_terms( $terms, $parent = false ) {
			...
			foreach ( $terms as $term ) {
				...
				if ( !empty( self::$filter['style']['style']['type'] ) ) {
					...
					$insert = '<span>' . esc_html( $title ) . $term_count . $tip . ( self::$filter['hierarchy'] == 'yes' && !empty( $term->children ) ? '<i class="prdctfltr-plus"></i>' : '' ) . '</span>';
		...
		public static function get_dynamic_filter_title_700() {
			...
			if ( self::$filter['title'] != '' ) {
				...
				if ( self::$filter['taxonomy'] !== 'price' && taxonomy_exists( self::$filter['taxonomy'] ) ) {
					...
					esc_html_e( 'Price', 'xforwoocommerce' );
				}
			}
		?>
			...
			if ( self::$filter['title'] != '' ) {
				...
				if ( substr( self::$filter['taxonomy'], 0, 3 ) == 'pa_' ) {
					...
					if ( self::$filter['taxonomy'] == 'product_cat' ) {
						esc_html_e( 'Categories', 'xforwoocommerce' );
					}
					else if ( self::$filter['taxonomy'] == 'product_tag') {
						esc_html_e( 'Tags', 'xforwoocommerce' );
					}
					else if ( self::$filter['taxonomy'] == 'characteristics' ) {
						esc_html_e( 'Characteristics', 'xforwoocommerce' );
					}
					else {
		...
		public static function catalog_instock( $get = '' ) {
			...
			$instock = array(
				'both'    => esc_html__( 'All Products', 'xforwoocommerce' ),
				'in'      => esc_html__( 'In Stock', 'xforwoocommerce' ),
				'out'     => esc_html__( 'Out Of Stock', 'xforwoocommerce' )
			);
		...
		public static function catalog_ordering() {
			...
			$orderby = array(
				'menu_order'       => esc_html__( 'Default', 'xforwoocommerce' ),
				'comment_count'    => esc_html__( 'Review Count', 'xforwoocommerce' ),
				'popularity'       => esc_html__( 'Popularity', 'xforwoocommerce' ),
				'rating'           => esc_html__( 'Average rating', 'xforwoocommerce' ),
				'date'             => esc_html__( 'Newness', 'xforwoocommerce' ),
				'price'            => esc_html__( 'Price: low to high', 'xforwoocommerce' ),
				'price-desc'       => esc_html__( 'Price: high to low', 'xforwoocommerce' ),
				'rand'             => esc_html__( 'Random Products', 'xforwoocommerce' ),
				'title'            => esc_html__( 'Product Name', 'xforwoocommerce' )
			);
		...
		<?php
			if ( self::$settings['instance']['total'] == 0 ) {
				echo esc_html__( 'No products found!', 'xforwoocommerce' );
			}
			else if ( self::$settings['instance']['total'] == 1 ) {
				if ( $pf_step_filter !== '' ) {
					echo esc_html__( 'Found a single result', 'xforwoocommerce' );
				}
				else {
					echo esc_html__( 'Showing the single result', 'xforwoocommerce' );
				}
			}
			else if ( self::$settings['instance']['total'] <= self::$settings['instance']['per_page'] || -1 == self::$settings['instance']['per_page'] ) {
				if ( $pf_step_filter !== '' ) {
					echo esc_html__( 'Found', 'xforwoocommerce' ) . ' ' . absint( self::$settings['instance']['total'] ) . ' ' . esc_html__( 'results', 'xforwoocommerce' );
				}
				else {
					echo esc_html__( 'Showing all', 'xforwoocommerce' ) . ' ' . absint( self::$settings['instance']['total'] ) . ' ' . esc_html__( 'results', 'xforwoocommerce' );
				}
			}
			else {
				if ( $pf_step_filter !== '' ) {
					...
					echo esc_html__( 'Showing', 'xforwoocommerce' ) . ' ' . absint( self::$settings['instance']['first'] ) . ' - ' . absint( self::$settings['instance']['last'] ) . ' ' . esc_html__( 'of', 'xforwoocommerce' ) . ' ' . absint( self::$settings['instance']['total'] ) . ' ' . esc_html__( 'results', 'xforwoocommerce' );
				}
			}
		?>
			</span>
			...
			?>
				...
				<?php
					if ( self::$settings['instance']['style']['filter_title'] !== '' ) {
						...
						esc_html_e( 'Filter products', 'xforwoocommerce' );
					}
				?>
					</span>
				<?php
		...
		public static function get_filter_search() {
			...
			$pf_placeholder = self::$filter['placeholder'] != '' ? esc_attr( self::$filter['placeholder'] ) : esc_attr( esc_html__( 'Product keywords', 'xforwoocommerce' ) );
		...
		public static function _get_filter_meta_range_terms() {
			...
			if ( empty( self::$filter['style']['terms'] ) ) {
				esc_html_e( 'Error! No terms!', 'xforwoocommerce' );
			}
			else {
		...
		public static function get_filter_meta_terms() {
			...
			if ( !self::___check_for_hidden( 'none' ) ) {
				printf('<label class="prdctfltr_ft_none"><input type="checkbox" value="" />%1$s</label>', wp_kses_post( ( !empty( self::$filter['style']['style']['type'] ) ? self::get_customized_term_700( '', 'none', apply_filters( 'prdctfltr_none_text', esc_html__( 'None', 'xforwoocommerce' ) ), false ) : '<span>' . apply_filters( 'prdctfltr_none_text', esc_html__( 'None', 'xforwoocommerce' ) ) . '</span>' ) ) );
			}
			...
			switch( $filter['filter'] ) {
				...
				case 'search' :
					...
					self::$filter = array_merge( array(
						...
						'title'         => esc_html__( 'Search Products', 'xforwoocommerce' ),
						'desc'          => '',
						'placeholder'   => '',
						'style'         => '',
						'class'         => 'search',
				...
				case 'per_page' :
					...
					self::$filter = array_merge( array(
						'filter'        => $filter['filter'],
						'title'         => esc_html__( 'Per Page', 'xforwoocommerce' ),
						'desc'          => '',
						'style'         => '',
						'class'         => 'perpage',
				...
				case 'instock' :
					...
					self::$filter = array_merge( array(
						'filter'        => $filter['filter'],
						'title'         => esc_html__( 'Availability', 'xforwoocommerce' ),
						'desc'          => '',
						'include' => array(
							'relation' => 'IN',
							'selected' => array()
				...
				case 'sort' :
					...
					self::$filter = array_merge( array(
						'filter'        => $filter['filter'],
						'title'         => esc_html__( 'Order By', 'xforwoocommerce' ),
						'desc'          => '',
						'include' => array(
							'relation' => 'IN',
							'selected' => array()
				...
				case 'vendor' :
					...
					self::$filter = array_merge( array(
						'filter'        => $filter['filter'],
						'title'         => esc_html__( 'Vendor', 'xforwoocommerce' ),
						'desc'          => '',
						'include' => array(
							'relation' => 'IN',
							'selected' => array()
				...
				case 'price' :
					...
					self::$filter = array_merge( array(
						'filter'        => $filter['filter'],
						'title'         => esc_html__( 'Price', 'xforwoocommerce' ),
						'desc'          => '',
						'include' => array(
							'relation' => 'IN',
							'selected' => array()
				...
				case 'meta' :
					...
					self::$filter = array_merge( array(
						'filter' => 'meta',
						'title' => esc_html__( 'Meta', 'xforwoocommerce' ),
						'desc' => '',
		...
		public static function get_filter_maxheight() {
			...
			if ( !isset( self::$settings['maxheight'] ) ) {
				$max = ( !empty( self::$settings['instance']['style']['max_height'] ) ? absint( self::$settings['instance']['style']['max_height'] ) . 'px' : '' );
...
<?php
		...
		public static function get_filter_taxonomy_terms() {
			...
			if ( !self::___check_for_hidden( 'none' ) ) {
				if ( !empty( self::$filter['style']['style']['type'] ) ) {
					$blank = self::get_customized_term_700( '', 'none', apply_filters( 'prdctfltr_none_text', esc_html__( 'None', 'xforwoocommerce' ) ), false );
				}
				else {
					$blank = apply_filters( 'prdctfltr_none_text', esc_html__( 'None', 'xforwoocommerce' ) );
				}
