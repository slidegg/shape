		...
		public function ___get_preset( $key ) {
			...
			if ( isset( $key ) && is_string( $key ) ) {
				...
				if ( $option === false && $lang !== '' ) {
					$option = get_option( '_prdctfltr_preset_' . $key, false );
				}
		...
		public function register_taxonomy( $taxonomy ) {
			...
			if ( !empty( $taxonomy_slug ) && !taxonomy_exists( $taxonomy_slug ) ) {
				$labels = array(
					...
					'search_items'               => esc_html__( 'Search', 'xforwoocommerce' ) . ' ' . $taxonomy_plural,
					'popular_items'              => esc_html__( 'Popular', 'xforwoocommerce' ) . ' ' . $taxonomy_plural,
					'all_items'                  => esc_html__( 'All', 'xforwoocommerce' ) . ' ' . $taxonomy_plural,
					'parent_item'                => null,
					'parent_item_colon'          => null,
					'edit_item'                  => esc_html__( 'Edit', 'xforwoocommerce' ) . ' ' . $taxonomy_plural,
					'update_item'                => esc_html__( 'Update', 'xforwoocommerce' ) . ' ' . $taxonomy_plural,
					'add_new_item'               => esc_html__( 'Add New', 'xforwoocommerce' ) . ' ' . $taxonomy_single,
					'new_item_name'              => esc_html__( 'New', 'xforwoocommerce' ) . ' ' . $taxonomy_single . ' ' . esc_html__( 'name', 'xforwoocommerce' ),
					'separate_items_with_commas' => esc_html__( 'Separate', 'xforwoocommerce' ) . ' ' . $taxonomy_plural . ' ' . esc_html__( 'with commas', 'xforwoocommerce' ),
					'add_or_remove_items'        => esc_html__( 'Add or remove', 'xforwoocommerce' ) . ' ' . $taxonomy_plural,
					'choose_from_most_used'      => esc_html__( 'Choose from the most used', 'xforwoocommerce' ) . ' ' . $taxonomy_plural,
					'not_found'                  => esc_html__( 'No', 'xforwoocommerce' ) . ' ' . $taxonomy_plural . ' ' . esc_html__( 'found', 'xforwoocommerce' ),esc_html__( 'No Characteristics found', 'xforwoocommerce' ),
